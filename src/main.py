...
if __name__ == "__main__":
    ...
    create_xyz_file_coordinates("../outputs/initial_config_coords.xyz")
    ...
    if opt.minimize_potential == True:
        ...
        create_xyz_file_coordinates("../outputs/minimized_config_coords.xyz")
    
    generate_initial_velocities(opt.initial_velocity, opt.temperature)
    create_xyz_file_velocities("../outputs/initial_config_velocities.xyz")
    f = open('../outputs/argon_coordinates.pdb', 'w')
    f.write("HEADER\n")
